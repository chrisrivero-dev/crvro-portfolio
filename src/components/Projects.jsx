...
const HOMEPAGE_PROJECTS = PROJECTS.filter((p) => p.id !== "predmkt-bot");
  ...
  const recompute = useCallback(() => {
    ...
    for (let i = 0; i < 4; i++) {
      ...
      pts.push({
        ...
        color: HOMEPAGE_PROJECTS[i].accent,
      });
    }
    ...
    return (
      ...
      >
        <div className="prm-card-top">
          <span className="prm-idx">{String(pi + 1).padStart(2, "0")}</span>
    ...
    <section className="work" id="work" data-screen-label="02 Work">
      <div className="container-wide">
        ...
        <div className="project-route-map" ref={mapRef}>
          ...
          {renderCard(3)}{/* GroundRules  — right col, row 2, offset */}
        </div>
