...
export const PROJECTS = [
  ...
  // ---------------------------------------------------------
  {
    ...
    year: '2026 — present',
    desc: 'A personal AI operator. Ask for an outcome, and Zarvin coordinates specialists, models, tools, permissions, execution, verification, and follow-up underneath.',
    tags: ['react native · expo · typescript · python · fastapi · local models'],
    accent: 'var(--teal)',
    shape: 'circle',
    role: 'Solo build — product design, AI orchestration, backend/runtime engineering, local model infrastructure, approval & verification workflow, testing',
    status: 'Active live build — a persistent AI operator running on my own hardware with real connected services. I distinguish verified capabilities from features still being hardened.',
    statusBadge: 'Active live build',
    outcome: 'A personal AI operator that connects real calendar, email, and meeting-notes tools, executes approved actions, verifies the result against the provider, and keeps an evidence-backed record of what actually happened — not just what it says happened.',
    ...
    publicStatus: [
      'Active live build — running daily on my own hardware, not a demo.',
      'Real connected accounts: Google Calendar, two Gmail accounts, Granola meeting notes.',
      'Consequential actions are approval-gated, executed, and independently verified against the provider.',
