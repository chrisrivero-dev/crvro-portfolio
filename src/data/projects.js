...
export const PROJECTS = [
  ...
  // ---------------------------------------------------------
  {
    ...
    n: '05',
    title: 'GroundRules',
    titleEm: '— first-pass property screening from public records.',
    kind: 'Web app / Property intel',
    year: '2026',
    desc: 'GroundRules helps ADU builders, architects, permit expediters, small developers, and real estate professionals quickly screen whether an address is worth deeper review using public parcel, zoning, hazard, and jurisdiction data. It turns an address or parcel into a plain-English first-pass report showing what may be possible, what looks risky, and what needs verification.',
    ...
    overview: [
      ...
      'GroundRules does not replace official review, jurisdiction interpretation, or professional judgment. It helps surface the right questions earlier so the next step is easier to verify.',
    ],
    problem: [
