...
export const PROJECTS = [
  ...
  // ---------------------------------------------------------
  {
    ...
    n: '01',
    title: 'Help Nearby',
    titleEm: '— a community resource platform.',
    kind: 'Web app',
    year: '2024',
    desc: 'Find nearby help by ZIP, check urgent local updates, get map-based directions, and discover community resources — no account required.',
