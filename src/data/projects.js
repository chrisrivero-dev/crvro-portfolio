...
export const PROJECTS = [
  ...
  // ---------------------------------------------------------
  {
    ...
    kind: 'AI Workflow',
    year: '2025 — present',
    desc: 'Hermes is a human-supervised AI workflow system that coordinates local and cloud models across research, development, auditing, documentation, and deployment — reachable through Telegram, local services, and connected tools.',
    tags: ['python · ollama · llm routing · telegram'],
    accent: 'var(--plum)',
    shape: 'stack',
    role: 'Solo build — AI workflow orchestration, local model infrastructure, developer tooling',
    ...
    problem: [
      'A cloud-only assistant is convenient and uncomfortable in equal measure: the more useful it becomes, the more access it usually wants. I did not want a broad, unsupervised agent — I wanted an operations layer that could take on real development work without handing over the control loop.',
  ...
  // ---------------------------------------------------------
  {
    ...
    year: '2026',
    desc: 'GroundRules turns an address into a cited, reviewable first-pass property screening report covering parcel context, zoning signals, jurisdiction notes, risk flags, and verification needs.',
