...
export const PROJECTS = [
  ...
  // ---------------------------------------------------------
  {
    ...
    year: '2026',
    desc: 'An AI property feasibility tool for ADU builders, architects, permit expediters, small developers, and real estate professionals. It turns an address or parcel into a plain-English first-pass report showing what may be possible, what looks risky, and what needs verification.',
    ...
    overview: [
      'GroundRules is an AI property feasibility tool for ADU builders, architects, permit expediters, small developers, and real estate professionals. It turns an address or parcel into a plain-English first-pass report showing what may be possible, what looks risky, and what needs verification.',
      ...
      'GroundRules does not replace official review, permit approval, or professional judgment. It helps surface the right questions earlier so the next step is easier to verify.',
    ],
    problem: [
      'Professionals often spend hours checking parcel records, zoning context, jurisdiction rules, overlays, and early permit risk before they know whether a project is worth pursuing.',
      'GroundRules compresses that first-pass feasibility work into a cited, reviewable report. The main wedge is ADU builders, architects, permit expediters, small developers, and real estate professionals, though homeowners can still use it as an earlier screening step before formal review.',
      'The first wedge is residential feasibility for ADUs, additions, solar, zoning context, and early permit risk.',
    ],
    built: [
